...
function get20s(artists){
  ...
  {
    number(artists[i].years);

    if(artists[i].years <= 1900 && artists[i].years >= 2000);
    {
      return this.artists[i].name;
    }
...
function removeArtist(artists, number){
  artists.splice(number, number+1);
...
function addArtist(artists){
    artists.push({id: 20, name: "Mason", years: "1999-2021", genre: "Web Design", nationality: "USA", bio: "I love League of Legends"});
    return(artists[20])
  }
